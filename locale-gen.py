...
def main():
    ...
    generate_mlterm(width_list)
    generate_vimrc(width_list)
...
def generate_mlterm(width_list):
    path = f'eaw-custom.mlterm'
    print(f'Generating {path} ... ', end='')
    with open(path, 'w') as out:
...
def generate_vimrc(width_list):
    path = f'eaw-custom.vim'
    print(f'Generating {path} ... ', end='')
    with open(path, 'w') as out:
        print('" Generated by locale-eaw', file=out)
        print('''
